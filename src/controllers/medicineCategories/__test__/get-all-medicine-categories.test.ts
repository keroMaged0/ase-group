...
beforeEach(async () => {
  const permissions = await dataSource
    ...
    .save({ key: PERMISSIONS.get_all_medicine_category });
...
describe('Get all Medicine Category', () => {
  it('should get all medicine categories successfully', async () => {
    const response = await request.get('/api/v1/medicine-categories').set('id', users[0].id);
  ...
  it('should not get all medicine categories for unauthorized user', async () => {
